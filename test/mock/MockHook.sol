...
import {IExecutionHook} from "src/interfaces/IERC7579Modules.sol";
import {MODULE_TYPE_EXECUTION_HOOK} from "src/types/Constants.sol";

contract MockHook is IExecutionHook {
    ...
    function isModuleType(uint256 moduleTypeId) external pure override returns (bool) {
        return moduleTypeId == MODULE_TYPE_EXECUTION_HOOK;
    }
